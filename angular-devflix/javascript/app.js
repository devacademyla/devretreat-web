...
angular.module("devflix").controller("SeriesController", SeriesController);

SeriesController.$inject = ["$http"];

function SeriesController($http) {
  this.mensaje = "Hola, estoy en el scope";
  $http.get("http://devflix.herokuapp.com/series")
